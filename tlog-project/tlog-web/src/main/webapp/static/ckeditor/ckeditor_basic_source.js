...
// Compressed version of services/ckeditor_base.js. See original for instructions.
/*jsl:ignore*/
...
document.write(
	'<script type="text/javascript" src="' + CKEDITOR.getUrl( '_source/services/loader.js' ) + '"></script>' );
