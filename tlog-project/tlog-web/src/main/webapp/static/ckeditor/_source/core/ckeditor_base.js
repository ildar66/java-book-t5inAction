...
if ( !window.CKEDITOR )
{
	...
	window.CKEDITOR = (function()
	{
		...
		/** @lends CKEDITOR */
		{
			...
			/**
			 * Private object used to hold services stuff. It should not be used out of
			 ...
			 *			<li><b>basic_ready</b>: the basic API is ready to load the full services code.</li>
			...
			basePath : (function()
			{
				...
				// var basePath in "services/loader.js".
